...
function ProgressbarComponent_bar_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("type", ctx_r262.type)("value", ctx_r262._value);
} }
function ProgressbarComponent_ng_template_1_bar_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("type", item_r265.type)("value", item_r265.value);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(item_r265.label);
} }
function ProgressbarComponent_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r263._value);
} }
var _c0 = ["*"];
